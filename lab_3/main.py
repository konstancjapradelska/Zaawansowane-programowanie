...
if zmienna3:print('Zadanie 3: Liczba parzysta')
else: print('Zadanie 3: Liczba nieparzysta')
...
# zadanie 5
def zad5(list,a):
    if a in list: return True
    else: return False

list=[2,6,3,8]
a=8
print('Zadanie 5:',zad5(list,a))
...
def zad6(list1,list2):
    ...
    counter=1
    for i in list3:
         if i in list3[counter:]:list3.remove(i)
         counter=counter+1
